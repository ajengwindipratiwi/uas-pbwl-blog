...
<div class="container">
	<h3>Edit Daftar Photos</h3>
	<form action="{{ url('/photos/' . $rows->photos_id) }}" method="POST">
		<input type="hidden" name="_method" value="PATCH">
		@csrf
		<table>
			<tr>
				<td>Tanggal Post</td>
				<td><input type="date" name="photos_date" value="{{ $rows->photos_date }}"></td>
			</tr>
			<tr>
				<td>Nama Gambar</td>
				<td><input type="text" name="photos_title" value="{{ $rows->photos_title }}"></td>
			</tr>
			<tr>
				<td>Keterangan</td>
				<td><input type="text" name="photos_text" value="{{ $rows->photos_text }}"></td>
			</tr>
			<tr>
				<td>ID Post</td>
				<td>
